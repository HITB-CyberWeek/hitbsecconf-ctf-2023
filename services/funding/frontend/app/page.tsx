...
import { loadWeb3, loadUserAddress } from "@/redux/interactions";
...
async function loadBlockchain(dispatch: AppDispatch) {
    ...
    if (web3 && web3.provider) {
        await loadUserAddress(web3, dispatch);
    }
}
...
export default function Home() {
    ...
    useEffect(() => {loadBlockchain(dispatch).then(() => {setConnecting(false)})}, [dispatch]);
